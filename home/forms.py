...
class CustomSignupForm(SignupForm):
    ...
    Adds fields for username, first name, last name, and email, with specific labels and requirements.
    """
    ...
    def save(self, request):
        """
        Saves the user instance with additional fields (username, first name, and last name).
