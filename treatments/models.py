...
class Treatment(models.Model):
    ...
    Includes fields for the treatment's name, description, services offered,
    benefits, price, image, and button text.
    """
...
class FAQ(models.Model):
    """
    Model representing a (FAQs) & its corresponding answer.
